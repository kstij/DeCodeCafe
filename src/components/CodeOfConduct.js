...
const CodeOfConduct = () => {
  return (
    <div className="code-of-conduct-container">
      <h1 className="main-heading">Contributor Covenant Code of Conduct</h1>
      <section>
        <h2 className="section-heading">Our Pledge</h2>
        <p>
      ...
      <section>
        <h2 className="section-heading">Our Standards</h2>
      ...
      <section>
        <h2 className="section-heading">Enforcement Responsibilities</h2>
        <p>
      ...
      <section>
        ...
        <p>
          Once our tenure ends. We will find some enthusiastic students to carry out our mission. We will make sure that the mission is passed on to a potential student who can help the student with a mixture of the community's ideology and the leader's new team discussions.
        </p>
      </section>
      <section>
        <h2 className="section-heading">Enforcement</h2>
        <p>
          Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at <a href="mailto:decodecafe.community@gmail.com">decodecafe.community@gmail.com</a> or @Rahulkhinchi03. All complaints will be reviewed and investigated promptly and fairly.
        </p>
        <p>
      ...
      <section>
        <h2 className="section-heading">Enforcement Guidelines</h2>
        ...
        <h3 className="subheading">1. Correction</h3>
        <p>Community Impact: Use of inappropriate language or other behavior deemed unprofessional or unwelcome in the community.</p>
        <p>Consequence: A private, written warning from community leaders, providing clarity around the nature of the violation and an explanation of why the behavior was inappropriate. A public apology may be requested.</p>
        <h3 className="subheading">2. Warning</h3>
        ...
        <h3 className="subheading">3. Temporary Ban</h3>
        ...
        <h3 className="subheading">4. Permanent Ban</h3>
